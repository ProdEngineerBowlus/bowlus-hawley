...
const COUNT_QUERIES = Object.freeze([
  ...
  ["raw.airtable_tasks", "select count(*)::int as count from raw.airtable_tasks"],
  ["raw.airtable_production", "select count(*)::int as count from raw.airtable_production"],
  ["raw.airtable_vins", "select count(*)::int as count from raw.airtable_vins"],
  ["raw.airtable_models", "select count(*)::int as count from raw.airtable_models"],
  ...
  ["hb.task_templates", "select count(*)::int as count from hb.task_templates"],
  ["hb.production_schedule", "select count(*)::int as count from hb.production_schedule"],
  ["hb.vins", "select count(*)::int as count from hb.vins"],
  ["hb.models", "select count(*)::int as count from hb.models"],
